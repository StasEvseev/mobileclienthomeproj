...
public class GoodBuyApiHolder implements BaseHolder<GoodBuyApi>{
    ...
    public String COL_COUNT_ORDER = "count_order";
    public String COL_COUNT_POSTORDER = "count_postorder";
    public String COL_COUNT_WHOLE_PACK = "count_whole_pack";
    public String COL_FULL_NAME = "full_name";
    public String COL_ID = "id";
    public String COL_NAME = "name";
    public String COL_NUMBER_GLOBAL = "number_global";
    public String COL_NUMBER_LOCAL = "number_local";
    public String COL_PLACER = "placer";
    public String COL_PRICE_WITH_NDS = "price_with_NDS";
    public String COL_PRICE_WITHOUT_NDS = "price_without_NDS";
    public String COL_RATE_NDS = "rate_NDS";
    public String COL_SUM_NDS = "sum_NDS";
    public String COL_SUM_WITH_NDS = "sum_with_NDS";
    public String COL_SUM_WITHOUT_NDS = "sum_without_NDS";
    public String COL_THEMATIC = "thematic";
    public String COL_GOOD_ID = "id_good";
